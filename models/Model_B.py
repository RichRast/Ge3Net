...
class model_B(object):
    ...
    def train(self, optimizer, training_generator, params, writer=None):
        ...
        for i, train_gen in enumerate(training_generator):
            ...
            train_x = out9.reshape(train_x.shape[0], params.dataset['n_win'], params.rnn_net['input_size'])
            rnn_state = None
        ...
        with torch.no_grad():
            ...
            for j, val_gen in enumerate(validation_generator):
                ...
                for _ in range(params.mc_samples):
                    ...
                    val_x_sample = out9.reshape(val_x.shape[0], params.dataset['n_win'], params.rnn_net['input_size'])
