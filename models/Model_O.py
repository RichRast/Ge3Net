...
class model_O(object):
    def __init__(self, aux_network, main_network, main_network2, main_network3, main_network4):

        self.aux_network = aux_network
        self.main_network = main_network
        self.main_network2 = main_network2
        self.main_network3 = main_network3
        self.main_network4 = main_network4
    ...
    def train(self, optimizer, training_generator, params, writer=None):
        ...
        for i, train_gen in enumerate(training_generator):
            ...
            if params.rnn_net['tbptt']:
                ...
                att_train_x1, att_scores1, weights1 = self.main_network2(train_lstm)
                train_vector, train_out, _ = self.main_network(att_train_x1)
                att_train_x, att_scores, weights = self.main_network4(train_vector)
    ...
    def eval(self, validation_generator, params, writer=None):
        ...
        with torch.no_grad():
            ...
            for j, val_gen in enumerate(validation_generator):
                ...
                for _ in range(params.mc_samples):
                    ...
                    att_val_x1, att_scores1, weights1 = self.main_network2(val_lstm)
                    val_vector, val_outputs, _ = self.main_network(att_val_x1)
                    att_val_x, att_scores, weights = self.main_network4(val_vector)
        ...
        return val_accr, y_pred, weights1, weights
